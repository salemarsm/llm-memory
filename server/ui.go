...
<div class="wrap">
  ...
  <section class="card">
    <div class="row" style="align-items:center;justify-content:space-between">
      ...
      <div><button onclick="newMemory()">Nova memória</button> <button class="secondary" onclick="loadDocuments()">Docs RAG</button> <button class="secondary" onclick="loadIngestionRuns()">Ingestões</button> <button class="secondary" onclick="loadEvents()">Eventos</button></div>
    </div>
  </section>
